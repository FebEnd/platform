package com.platform.parent.easemob.comm;
...
public class TokenUtil {
    ...
    /**
     * get token from easemob server
     */
    static {
        InputStream inputStream = TokenUtil.class.getClassLoader().getResourceAsStream("config/easemob.properties");
    ...
    public static String getAccessToken() {
        if (ACCESS_TOKEN == null || isExpired()) {
            //if no access token initialized or token is expired
            initTokenByProp();
        }
        return ACCESS_TOKEN;
    }
