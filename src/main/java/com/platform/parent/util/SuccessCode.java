...
public enum SuccessCode {
    ...
    MESSAGE_SEND_SUCCESSFULLY(0,"MESSAGE_SEND_SUCCESSFULLY","短信发送成功"),
    COMPLETE_INFO_SUCCESSFULLY(0,"COMPLETE_INFO_SUCCESSFULLY","完善信息成功"),
    ADD_FAVOR_SUCCESSFULLY(0,"ADD_FAVOR_SUCCESSFULLY","点赞成功");
    private int status;
